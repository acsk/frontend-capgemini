<template>
  <div>
    <div
      ...
      "
    >
      <h2 class="text-center">Caixa Eletrônico</h2>
          ...
          <div class="row">
            <div class="col-8">
              <input
                type="text"
                class="form-control"
                placeholder="Informe o númeor da conta"
                v-model="numero"
              />
            </div>
            <div class="col-4">
...
export default {
  data() {
    return {
      ...
      mensagem: "",
      error: false,
      uri: 'http://127.0.0.1:9000/api/contas' // URL DA API
    };
  },
